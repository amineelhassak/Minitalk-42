...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/29 08:48:14 by amel-has          #+#    #+#             */
/*   Updated: 2023/11/29 08:48:17 by amel-has         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	handel_unicode(unsigned char c, int *ind)
{
	...
	if (*ind == 1)
		(1 == 1) && (index = 0, nbrbyte = 0, *ind = 0, ft_memset(t, 0, 4));
	if (c >= 192 && c <= 223)
		nbrbyte = 2;
	else if (c >= 224 && c <= 239)
		nbrbyte = 3;
	...
	{
		write(1, t, nbrbyte);
		(1 == 1) && (index = 0, nbrbyte = 0, ft_memset(t, 0, 4));
	}
}
